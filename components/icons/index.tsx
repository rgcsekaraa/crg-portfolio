...
export function YouTubeIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d='M23.498 6.186a2.994 2.994 0 0 0-2.114-2.115C19.788 3.5 12 3.5 12 3.5s-7.787 0-9.385.571A2.993 2.993 0 0 0 .501 6.186 29.86 29.86 0 0 0 0 12c0 1.76.132 3.504.501 5.814a2.993 2.993 0 0 0 2.114 2.115C4.213 20.5 12 20.5 12 20.5s7.788 0 9.384-.571a2.994 2.994 0 0 0 2.114-2.115C23.867 15.504 24 13.76 24 12c0-1.76-.132-3.504-.502-5.814zM9.75 15.02v-6.04l6.26 3.02-6.26 3.02z' />
    </svg>
  )
}
