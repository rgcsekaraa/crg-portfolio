export const siteMetadata = {
  ...
  social: {
    email: 'rgcsekaraa@gmail.com',
    x: 'https://x.com/rgcsekaraa',
    linkedinLink: `https://www.linkedin.com/in/rgcsekaraa/`,
    githubLink: `https://github.com/rgcsekaraa/`
  }
}
