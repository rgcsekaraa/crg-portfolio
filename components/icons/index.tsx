...
export function YouTubeIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox='0 0 24 24' aria-hidden='true' {...props}>
      <path d='M23.5 7.5s-.2-1.7-1-2.5c-.9-.9-1.9-1-2.5-1C18.8 4 12 4 12 4s-6.8 0-7.9.5c-.6.1-1.6.1-2.5 1S1.5 7.5 1.5 7.5.5 9.5.5 12s0 4.5 0 4.5s.2 1.7 1 2.5c.9.9 1.9 1 2.5 1 1.1.5 7.9.5 7.9.5s6.8 0 7.9-.5c.6-.1 1.6-.1 2.5-1s1-2.5 1-2.5s.5-1.9.5-4.5s0-4.5 0-4.5zM9.5 15.5V8.9l6.5 3.1-6.5 3.5z' />
    </svg>
  )
}